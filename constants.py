...
# UI dimensions
MEDIA_TILE_SIZE = 150
MEDIA_TILE_SIZE_COMPACT = 110
MEDIA_TILE_SIZE_NORMAL = 150
MEDIA_TILE_SIZE_LARGE = 200
ALBUM_TILE_SIZE = MEDIA_TILE_SIZE
HOME_ALBUM_ART_SIZE = MEDIA_TILE_SIZE
HOME_GRID_COLUMNS = 5
HOME_LIST_LIMIT = HOME_GRID_COLUMNS * 2
SIDEBAR_WIDTH = 210
SIDEBAR_ACTION_MARGIN = 8
SIDEBAR_ART_SIZE = SIDEBAR_WIDTH - (SIDEBAR_ACTION_MARGIN * 2)
DETAIL_ART_SIZE = 200
DETAIL_ARTIST_AVATAR_SIZE = 22
DETAIL_BG_SIZE = 1600
